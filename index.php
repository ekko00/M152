				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<div>
								<div>
									<input type="file" name="fileToUpload" id="fileToUpload" multiple="multiple" accept="image/x-png,image/gif,image/jpeg">
									<input class="btn btn-primary btn-sm" type="submit" data-dismiss="modal" aria-hidden="true"/>
									<!--<button class="btn btn-primary btn-sm" type="submit" data-dismiss="modal" aria-hidden="true">Poster</button>-->
								</form>
							</div>
						</div>
					</div>
